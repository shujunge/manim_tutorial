...
class Geometric_progression(Scene):
    ...
    def construct(self):
        ...
        text_1 = TextMobject('等比数列', font='新蒂小丸子体').scale(0.75).to_corner(UP * 2.4 + LEFT * 2)
        text_2 = TextMobject('几何级数', font='新蒂小丸子体').scale(0.75).to_corner(UP * 2.4 + LEFT * 2)

        text_3 = TextMobject('（当r的绝对值小于1时收敛）', font='新蒂小丸子体', color=BLUE).scale(0.6).next_to(text_2, RIGHT)

        text_4 = TextMobject('本视频将使用', font='新蒂小丸子体').scale(0.7).to_corner(UP * 8 + LEFT * 2)
        text_4_2 = TextMobject('Manim', font='新蒂小丸子体', color=ORANGE).scale(0.85).next_to(text_4, RIGHT)
        text_4_3 = TextMobject('数学动画给大家', font='新蒂小丸子体').scale(0.7).next_to(text_4_2, RIGHT)
        text_5 = TextMobject('带来', font='新蒂小丸子体').scale(0.7).to_corner(UP * 11 + LEFT * 2)
        text_5_2 = TextMobject('几何级数', font='新蒂小丸子体', color=BLUE).scale(0.7).next_to(text_5, RIGHT)
        text_5_3 = TextMobject('结果的可视化展示', font='新蒂小丸子体').scale(0.7).next_to(text_5_2, RIGHT)

        a1 = TextMobject('a', font='Comic Sans MS', color=BLUE).scale(0.8).to_corner(UP * 5.6 + LEFT * 3)
        a2 = TextMobject('ar', font='Comic Sans MS', color=BLUE).scale(0.8).next_to(a1, RIGHT * 4.4).align_to(a1, DOWN)
        two = TextMobject('2', font='Comic Sans MS', color=BLUE).scale(0.5).move_to(a2).shift(UP * 0.32 + RIGHT  * 0.32)
        three = TextMobject('3', font='Comic Sans MS', color=BLUE).scale(0.5).move_to(a2).shift(UP * 0.32 + RIGHT * 0.32)
        a3 = VGroup(a2.copy(), two).next_to(a2, RIGHT * 4.4).align_to(a1, DOWN)
        a4 = VGroup(a2.copy(), three).next_to(a3, RIGHT * 4.2).align_to(a1, DOWN)

        dots = TextMobject('...', font='Comic Sans MS', color=BLUE).scale(0.8).next_to(a4, RIGHT * 4).shift(DOWN * 0.16)    #.align_to(a1, DOWN)
        ...
        self.play(Write(TextMobject('+', color=WHITE).scale(0.8).next_to(a1, RIGHT * 1.5).align_to(a1, DOWN)), run_time=0.4)
        self.play(Write(TextMobject('+', color=WHITE).scale(0.8).next_to(a2, RIGHT * 1.4).align_to(a1, DOWN)), run_time=0.4)
        self.play(Write(TextMobject('+', color=WHITE).scale(0.8).next_to(a3[0], RIGHT * 2).align_to(a1, DOWN)), run_time=0.4)
        self.play(Write(TextMobject('+', color=WHITE).scale(0.8).next_to(a4[0], RIGHT * 2).align_to(a1, DOWN)), run_time=0.4)
        self.wait(0.5)
...
class Plot_achiless_tortoise(GraphScene):
    ...
    def construct(self):
        ...
        achilles_svg = SVGMobject('./srcs/figs/Achilles.svg', color=BLUE, stroke_width=0.15).scale(0.7).move_to(self.coords_to_point(3.25, 2.1))
        tortoise_svg = SVGMobject('./srcs/figs/tortoise.svg', color=YELLOW).scale(0.25).move_to(self.coords_to_point(2.4, 4.5))
        ...
        text_1 = TextMobject('每次让阿基里斯每次运动到乌龟的位置，', font='新蒂小丸子体').scale(0.36).align_to(self.coords_to_point(6.5, 5.6), LEFT).align_to(self.coords_to_point(6.5, 5.6), UP)
        text_2 = TextMobject('乌龟则会在这段时间往前跑了一丢丢', font='新蒂小丸子体').scale(0.36).next_to(text_1, DOWN * 1).align_to(text_1, LEFT)
        ...
        text_3 = TextMobject('每个阶段对应时间为：', font='新蒂小丸子体').scale(0.36).next_to(text_2, DOWN * 1.6).align_to(text_2, LEFT)
        ...
        text_4 = TextMobject('每个阶段对应路程为：', font='新蒂小丸子体').scale(0.36).next_to(text_31, DOWN * 1.6).align_to(text_2, LEFT)
        ...
        text_5 = TextMobject('则，追乌龟的总路程（或总时间）为：', font='新蒂小丸子体').scale(0.36).next_to(text_41, DOWN * 1.6).align_to(text_4, LEFT)
...
class Intro_achilles(Scene):
    ...
    def construct(self):
        ...
        text_1 = TextMobject('如何证明更一般的情况呢？', font='新蒂小丸子体', color=BLUE).scale(0.9).shift(UP * 1.8)
        text_2 = TextMobject('让我们来回顾一个经典的问题', font='新蒂小丸子体', color=YELLOW).scale(0.7).shift(UP * 0.25)
