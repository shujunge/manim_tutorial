...
class HistoryOfOurPeople(TeacherStudentsScene):
    def construct(self):
        self.teacher_says(
            ...
            bubble_kwargs={"width": 4, "height": 3,"direction": RIGHT}
        )
...
class AskPuzzle(TeacherStudentsScene):
    def construct(self):
        ...
        self.teacher_says(series,bubble_kwargs={"width": 4, "height": 3,"direction": RIGHT})
        ...
        self.play(
            ...
            PiCreatureSays(self.teacher, response, bubble_kwargs={"width": 4, "height": 3,"direction": RIGHT})
        )
...
class StatisticsVsEmpathy(PiCreatureScene):
    ...
    def construct(self):
        ...
        priors.next_to(randy, UP, LARGE_BUFF)
        prior = priors[0]
        prior.save_state()

        self.play(PiCreatureSays(
            morty,
            "1 in 1{,}000 people \\\\ have this disease.",bubble_kwargs={"width": 4, "height": 3,"direction": RIGHT},
    ...
    def create_pi_creatures(self):
        """
        Randolph, Mortimer, Mathematician, BabyPiCreature, TauCreature
        :return:
        """
